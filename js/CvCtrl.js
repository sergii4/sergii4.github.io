cvApp.controller('CvCtrl', ['$scope', function($scope) {
    ...
    {'company': 'Earlier Experience (Java)',
     'name': '',
     'desc': 'Java Developer roles at Intellias, GlobalLogic, Dubit, Levi9, and Epam',
     'date': '2010 - 2018',
     'position': 'Senior Java Developer',
     'achievementsList': [
       'Designed and implemented microservices using Spring ecosystem',
       'Worked with Docker, Kubernetes, and AWS in cloud-native environments',
